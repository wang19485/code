...
int main () {
  ...
  // add tests for DoublyLinkedListLength
    ...
    DListNode *node1 = dll2.getFirst();
    dll2.insertAfter(*node1, 5);
    cout << "list: " << dll2 << endl << endl;
    
    cout << "Call insertBefore: " << endl;
    dll2.insertBefore(*node1, 5);
    cout << "list: " << dll2 << endl << endl;
  ...
  cout << DoublyLinkedListLength(dll2) << endl << endl;
    ...
    DoublyLinkedQueue ll;
    cout << ll.isEmpty() << endl << endl;
    
    cout << "Using enqueue to insert 20 nodes at back with value 10,20,30,..,100 two times." << endl;
    for (int j = 0; j < 2; j++) {
        for (int i=10;i<=100;i+=10) {
            ll.enqueue(i);
        }
    ...
    cout << "Using dequeue to delete 11 nodes from first: ";
    for (int i = 0; i < 11; i++) {
        cout << ll.dequeue() << " ";
    }
    cout << endl;
