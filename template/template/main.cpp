...
int main(){
    ...
    try{
        ...
        int b = 0;
        cin >> a >> b;
        My_matrix<double> m1(a,b); // constructor called
        ...
        My_matrix<double> m3 = m1; // copy constructor called
        My_matrix<double> m4;
